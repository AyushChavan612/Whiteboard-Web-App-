...
import { useSelectionBounds } from "@/hooks/use-selections-bound";
import { useSelf, useStorage } from "@/liveblocks.config";
import { LayerType, Side, XYWH } from "@/types/canvas";
import { memo } from "react";

interface SelectionBoxProps {
    onReszieHandlePointerDown: (corner: Side, initialBounds: XYWH) => void;
}

const HANDLE_WIDTH = 8;

export const SelectionBox = memo(
    ({ onReszieHandlePointerDown }: SelectionBoxProps) => {
                ...
                {isShowingHandles && (
                    <>
                        <rect
                            ...
                            onPointerDown={(e) => {
                                e.stopPropagation();
                                onReszieHandlePointerDown(Side.Top+Side.Left,bounds);
                            }}
                        />
                        <rect
                            className="fill-white stroke-1 stroke-blue-500"
                            ...
                            onPointerDown={(e) => {
                                e.stopPropagation();
                                onReszieHandlePointerDown(Side.Top,bounds);
                            }}
                        />
                        <rect
                            className="fill-white stroke-1 stroke-blue-500"
                            ...
                            onPointerDown={(e) => {
                                e.stopPropagation();
                                onReszieHandlePointerDown(Side.Top+Side.Right,bounds);
                            }}
                        />
                        <rect
                            className="fill-white stroke-1 stroke-blue-500"
                            ...
                            onPointerDown={(e) => {
                                e.stopPropagation();
                                onReszieHandlePointerDown(Side.Right,bounds);
                            }}
                        />
                        <rect
                            className="fill-white stroke-1 stroke-blue-500"
                            ...
                            onPointerDown={(e) => {
                                e.stopPropagation();
                                onReszieHandlePointerDown(Side.Bottom+Side.Right,bounds);
                            }}
                        />
                        <rect
                            className="fill-white stroke-1 stroke-blue-500"
                            ...
                            onPointerDown={(e) => {
                                e.stopPropagation();
                                onReszieHandlePointerDown(Side.Bottom,bounds);
                            }}
                        />
                        <rect
                            className="fill-white stroke-1 stroke-blue-500"
                            ...
                            onPointerDown={(e) => {
                                e.stopPropagation();
                                onReszieHandlePointerDown(Side.Bottom+Side.Left,bounds);
                            }}
                        />
                        <rect
                            className="fill-white stroke-1 stroke-blue-500"
                            ...
                            onPointerDown={(e) => {
                                e.stopPropagation();
                                onReszieHandlePointerDown(Side.Left,bounds);
                            }}
                        />
                    </>
                )}
